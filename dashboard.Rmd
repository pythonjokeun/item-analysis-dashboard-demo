...
Items available are limited using [80/20 rule](https://en.wikipedia.org/wiki/Pareto_principle). More detail about how to do it, have a look at source code [here](https://github.com/iamsniffles/item-analysis-dashboard-demo/blob/master/pre-process.R).
