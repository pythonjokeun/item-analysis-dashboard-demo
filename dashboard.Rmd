...
Note that items available for analysis are limited using [80/20 rule](https://en.wikipedia.org/wiki/Pareto_principle). 

More detail on how to reproduce this dashboard available at [this repo](https://github.com/iamsniffles/item-analysis-dashboard-demo/).
